    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                BannerText("Providing a negative value for initial velocity can create a cool effect where the view 'backs up' before taking off.",
...
struct InterpolatingSpring_Previews: PreviewProvider {
